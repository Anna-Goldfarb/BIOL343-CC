...
```{r area-histogram}
knitr::opts_chunk$set(echo = FALSE)
ggplot(aes(x=ovary_area), data=cc1_data) + geom_histogram() + labs(title="Ovary Area by Population type", xlab="Ovary Area (mm^2)", ylab="Population Type (A/S)") + theme_classic()
```
